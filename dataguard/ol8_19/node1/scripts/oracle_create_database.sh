...
ALTER DATABASE ADD STANDBY LOGFILE THREAD 1 GROUP 10 ('${DATA_DIR}/${ORACLE_SID^^}/standby_redo05.log') SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE THREAD 1 GROUP 11 ('${DATA_DIR}/${ORACLE_SID^^}/standby_redo04.log') SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE THREAD 1 GROUP 12 ('${DATA_DIR}/${ORACLE_SID^^}/standby_redo03.log') SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE THREAD 1 GROUP 13 ('${DATA_DIR}/${ORACLE_SID^^}/standby_redo04.log') SIZE 50M;
